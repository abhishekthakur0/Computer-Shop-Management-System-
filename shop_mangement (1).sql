...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2018 at 10:47 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `supd` (OUT `sql` VARCHAR(100))  NO SQL
SELECT f_name,l_name,email,phone_number,address FROM supplier$$
...
('Sanjay Karn', '9546754125', 11200, '2018-11-19', '09:18:00', 13, 2300),
('Sanjay Karn', '9546754125', 0, '2018-11-19', '09:19:00', 14, 0),
('Abhishek', '9546754125', 20550, '2018-11-19', '09:33:00', 15, 550),
('Yaggi karn', '9008422080', 0, '2018-11-20', '02:50:00', 16, 0),
('Yaggi karn', '9008422080', 1370, '2018-11-20', '02:51:00', 17, 120),
('Yaggi karn', '9008422080', 7000, '2018-11-20', '02:54:00', 18, 2000),
('Yaggi karn', '9008422080', 84000, '2018-11-20', '02:59:00', 19, 24000),
('Yaggi karn', '9008422080', 21000, '2018-11-20', '03:47:00', 20, 1401),
('Chatur', 'Harijan', 1000, '2018-11-20', '05:06:00', 21, 901),
('Hari', 'Thakur', 1000, '2018-11-21', '02:49:00', 22, 901);
...
(1, 'Electricity Bill', '2018-05-30', 30000),
(2, 'Tan Bill', '2018-01-15', 5000),
(3, 'Cold Drink', '2018-02-15', 500);
...
(1, 'Hard disk 1TB', 1000, 'Segate 1TB', 8, 99),
(2, 'Desktop Computer', 20000, 'i5(6th gen),4 GB , 1TB HDD,Integrated graphics', 44, 19500),
(3, 'Memory card 32', 500, 'Sand disk 32 GB', 45, 450),
(4, 'Memory card 128', 10000, 'Samsung 128GB', 50, 450),
(5, 'keyboard', 500, 'Dell wired keyboard', 50, 450),
(6, 'keyboard mouse combo', 550, 'Intex keyboard mouse combo', 49, 500),
...
(19, 'Bluetooth speaker', 370, 'blue tooth multimedia speakers', 49, 350),
...
(23, 'Hp laptop bag', 500, 'Hp laptop bag', 9, 450),
...
(52, 'Intex IT-881U 2.1 Computer Multimedia Speakers', 5000, 'Intex IT-881U 2.1 Computer Multimedia Speakers', 29, 3500),
(53, 'Logitech M235 Wireless Mouse (Grey)', 1200, 'Logitech M235 Wireless Mouse (Grey)', 58, 900),
(54, 'Micromax Tab P290 (7 inch, 8GB, Wi-Fi Only), Black', 5000, 'Micromax Canvas Tab P290 Tablet (7 inch, 8GB, Wi-Fi Only), Black', 9, 4500),
...
(131, 'WERTYUI', 255, 'WTRTSDLD', 10, 12),
(132, 'ASDFG', 20, 'JHGFD', 5, 10),
(133, 'WERTYUI', 20, 'WTRTSDLD', 5, 10),
(140, 'weryu', 252, 'sdfghjk', 10, 20),
(144, 'WERTYUI', 2323, 'WTRTSDLD', 111, 12),
(191, 'lenevo laptop', 7000, '2TB, 8GB ram', 0, 5000),
(300, 'Dell Inspiron laptop', 50000, '2TB, 8GB ram', 12, 30000),
(444, 'Beast Pro Headphone', 15000, 'bluetooth headphone', 22, 5000);
...
INSERT INTO `supplier` (`id`, `f_name`, `l_name`, `email`, `phone_number`, `Address`) VALUES
(2, 'Jogiya', 'Ram', 'JogiyaRam@gmail.com', '04156232655', 'Mahadevpatti-8'),
(3, 'Ful', 'Kumari', 'fulkumari@gmail.com', '056332255584', 'Omgaun'),
(4, 'Bitaan', 'Lohar', 'bitanlohar@gmail.com', '0987523569', 'Halkhori-2');
...
(9, 'Abhishek', 'Thakur', 'kumar@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '12233333333', 'sdfghj'),
(12, 'Aashique', 'Karn', 'aashiquekarn@gmail.com', 'b404f7373be4e9864ef5ea87d8b927c7', '9008422080', 'Janakpur-7'),
(15, 'Ram', 'Khelawan', 'RamKhelawan@gmail.com', '3052ebfd25148f7f242bb4dfee06eae1', '9008422080', 'Fulhair-9'),
(16, 'Hira', 'Chopra', 'hirachopra@gmail.com', '6ebe76c9fb411be97b3b0d48b791a7c9', '0445987621', 'Bathnaha-9');
